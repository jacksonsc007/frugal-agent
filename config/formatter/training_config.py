"""
Training configuration for formatter model with Unsloth.
This file contains all the hyperparameters and configuration settings
extracted from train_formatter.py
"""
...
def get_experiment_config():
    """Get experiment configuration based on environment variable or default."""
    exp_name = os.environ.get("EXP_NAME", "tmp")
